<?php if (!defined('THINK_PATH')) exit();?><html><head>
  ...
  <link href="/workerman/Applications/Chat/Web/css/bootstrap.min.css" rel="stylesheet">
  <link href="/workerman/Applications/Chat/Web/css/style.css" rel="stylesheet">
  <!-- Include these three JS files: -->
  <script type="text/javascript" src="/workerman/Applications/Chat/Web/js/swfobject.js"></script>
  <script type="text/javascript" src="/workerman/Applications/Chat/Web/js/web_socket.js"></script>
  <script type="text/javascript" src="/workerman/Applications/Chat/Web/js/jquery.min.js"></script>

  <script type="text/javascript">
    if (typeof console == "undefined") {    this.console = { log: function (msg) {  } };}
    // 如果浏览器不支持websocket，会使用这个flash自动模拟websocket协议，此过程对开发者透明
    WEB_SOCKET_SWF_LOCATION = "/workerman/Applications/Chat/Web/swf/WebSocketMain.swf";

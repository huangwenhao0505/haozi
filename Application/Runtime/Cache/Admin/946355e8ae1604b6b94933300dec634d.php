...
$('#logout').bind().click(function(){
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">幽默笑话管理</a><span class="crumb-step">&gt;</span><span>新增笑话</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                <input type="hidden" name="id" id="ids" value="<?php echo $info['id'];?>"/>
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo $info['content'];?></textarea></td>
                            </tr>
...
<script>
 $('#but').bind().click(function(){
	 ...
	 $.ajax({
		 type:'post',
		 url:'<?php echo U("Admin/Joke/editJoke");?>',

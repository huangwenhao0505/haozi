            ...
            <form name="myform" id="myform" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" id="result-tab" width="100%">
                    	<thead>
                        <tr>
                            <th class="tc" width="1%"><input class="allChoose" id="allChoose" name="" type="checkbox"></th>
                            <th width="6%" style="text-align:center;">发布人</th>
                            <th width="6%" style="text-align:center;">发布者类别</th>
                            <th width="5%" style="text-align:center;">所属类别</th>
                            <th width="6%" style="text-align:center;">封面图</th>
                            <th width="10%" style="text-align:center;">标题</th>
                            <th width="18%" style="text-align:center;">简介</th>
                            <th width="3.5%" style="text-align:center;">浏览量</th>
                            <th width="3.5%" style="text-align:center;">评论量</th>
                            <th width="3.5%" style="text-align:center;">点赞量</th>
                            <th width="6%" style="text-align:center;">是否fine类型</th>
                            <th width="6%" style="text-align:center;">置顶</th>
                            <th width="6%" style="text-align:center;">推荐</th>
		...
		function(data){
			...
			if(d.list != false && d.list != null){
				for(var o in d.list){
					...
					html += '<td>'+d.list[o].cateName+'</td>';
					html += '<td><img src="'+d.list[o].img_url+'" width="80px;" height="80px"/></td>';
					html += '<td>'+d.list[o].title+'</td>';
					html += '<td>'+d.list[o].jianjie+'</td>';
					html += '<td style="text-align:center;">'+d.list[o].view_count+'</td>';
					html += '<td style="text-align:center;">'+d.list[o].comment_count+'</td>';
					html += '<td style="text-align:center;">'+d.list[o].like_count+'</td>';
					html += '<td style="text-align:center;">'+d.list[o].isFine+'</td>';
